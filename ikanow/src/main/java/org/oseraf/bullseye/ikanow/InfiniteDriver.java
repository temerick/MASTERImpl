/**
 * This class is almost entirely a copy of the InfiniteDriver provided by Ikanow. The only difference is
 * that sendPostRequest and sendGetRequest trust all ssl connections by default (bad idea).
 */
...
public class InfiniteDriver
{
    ...
    private String sendPostRequest(String urlAddress, String data) throws MalformedURLException, IOException, Exception
    {
        return sendPostRequest(urlAddress, data, 0);
    }
    private String sendPostRequest(String urlAddress, String data, int redirects) throws MalformedURLException, IOException, Exception
    {
        String result = "";
        ...
        URLConnection conn = new URL(urlAddress).openConnection();
        ...
        if (status != HttpURLConnection.HTTP_OK)
            {
                if (status == HttpURLConnection.HTTP_MOVED_TEMP
                    ...
                    {
                        if (redirects <= 5) {
                            String newUrlAddress = urlConnection.getHeaderField("Location");
